...
export const seedPatients = async () => {
  ...
  const patients: Patient[] = [
    ...
    },
    {
      ...
      allergies: 'None',
      conditions: 'None',
      contactName: 'Wendy Taylor',
      emergencyPhone: '+1-555-1005',
      isActive: true,
      createdAt: now,
      updatedAt: now,
    },
